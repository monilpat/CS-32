...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    {
        c2=countIncludes(a1+1, n1-1, a2+1, n2-1)+countIncludes(a1+1, n1-1, a2, n2);
    }
...
void order(double a[], int n)
{
    ...
    order(a, c);// Goes through the first half and continuely splits it
    order(a+d, n-d); // Goes through the second half and continually splits
}